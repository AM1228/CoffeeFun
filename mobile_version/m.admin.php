...
<head>
  ...
  <link rel="stylesheet" href="css/m.admin.css" type="text/css" />
...
function AcceptFunction(companyname) {
  //alert(companyname);
   ...
   jQuery.ajax({
        ...
        //alert('gg'); 
       window.location.href = "m.admin.php"; 
         }
    });
...
<nav class="navbar navbar-inverse bg-inverse">
 ...
 <div class="container-fluid">
     <ul class="nav navbar-nav navbar-left">
       <li><a class="navbar-brand" href="m.welcome.php"><span class="glyphicon glyphicon-chevron-left"></span></a></li>
     </ul>
