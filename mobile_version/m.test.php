...
<script>
    	      function ok(){
    	      window.location = "m.Enterprising.php";
}
 ...
 */   
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDiPkBv_WTSC0u3oNzYaRvdjGrNHBPelP4&libraries=places&callback=initAutocomplete"
         async defer></script>
